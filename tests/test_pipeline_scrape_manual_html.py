...
def test_run_scrape_uses_manual_html_for_athletic_source(tmp_path):
    ...
    article_html = """
    <html><head>
      <meta property="og:url" content="https://www.nytimes.com/athletic/7092398/2026/03/06/women-ncaa-tournament-bracket-watch-uconn-ucla/" />
    </head><body><article>
...
def test_run_scrape_derives_manual_athletic_article_url_from_html(tmp_path):
    config_dir = tmp_path / "config"
    data_dir = tmp_path / "data"
    latest_dir = data_dir / "latest"
    snapshot_dir = data_dir / "snapshots"
